...
- 다운로드 받은 파일(v2_6_1_full.yaml)에서 cluster-name을 현재 클러스터 이름으로 변경합니다. (line 854)
  ...
  <img width="451" alt="Screenshot 2023-07-05 at 12 10 26 AM" src="wget https://github.com/kubernetes-sigs/aws-load-balancer-controller/releases/download/v2.7.0/v2_7_0_full.yaml
">
